                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                            data-bs-target="#editModal{{ $kost->id }}"><i class="bi bi-pencil-square"></i></button>
                        {{-- Modal Edit --}}
                        <div class="modal fade
                                @if ($errors->any()) show @endif
                                "
                                        ...
                                        <form action="kost/update/{{ $kost->id }}" method="POST"
                                            ...
                                            <div class="mb-3">
                                                <label for="nama_pemilik"
                                                    class="form-label
                                                        @error('nama_pemilik') is-invalid @enderror">Nama
                                                    Pemilik</label>
                                                <input type="text" class="form-control" id="nama_pemilik"
                                                    name="nama_pemilik" value="{{ $kost->nama_pemilik }}">
                                                @error('nama_pemilik')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
